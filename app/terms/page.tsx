    ...
    >
      ...
      <div style={{ marginBottom: 48 }}>
        ...
        <div style={{ marginTop: 24, marginBottom: 20 }}>
          ...
          >
            Effective Date: {EFFECTIVE_DATE} &nbsp;·&nbsp; Governed by the Laws
        ...
        >
          ...
          >
            <strong>Important:</strong> Please read these Terms of Use carefully
            before accessing or using Deklata. By creating an account, logging
            in, or using any feature of the platform, you acknowledge that you
            have read, understood and agree to be legally bound by these Terms
            in their entirety. If you do not agree, you must discontinue use
            immediately.
          </p>
        </div>
      </div>
      ...
      <Section number="1" title="About Deklata & Platform Nature">
        <P>
          Deklata is a free, peer-to-peer student item exchange platform
          operating in Ghana. It enables registered students to give away items
          they no longer need and to request items offered by other students on
          participating campuses, currently including the University for
          Development Studies (UDS) Tamale Campus, UDS Nyankpala Campus and
          Tamale Technical University.
        </P>
        <P>
          Deklata operates exclusively as a{" "}
          <strong>technology intermediary</strong>. It provides the digital
          infrastructure through which students may connect — nothing more.
          Deklata does not at any time own, purchase, sell, store, inspect,
          appraise, insure, ship, deliver, handle, or take physical possession
          of any item listed or exchanged on the platform.
        </P>
        <P>
          Deklata expressly disclaims any role as agent, broker, principal,
          auctioneer, employer, franchisor, partner, joint venture participant,
          or co-owner with respect to any user, listing, item, or transaction
          conducted through or facilitated by the platform.
        </P>
        <P>
          All exchanges are voluntary, free of monetary consideration, and
          conducted entirely at the independent discretion of the users
          involved.
        </P>
      </Section>
      ...
      <Section number="2" title="Eligibility & Account Registration">
        ...
        />
        <P>
          You may not create an account on behalf of another person or entity.
          You are solely responsible for all activity that occurs under your
          account. You agree to maintain the confidentiality of your login
          credentials and to notify Deklata immediately of any unauthorized use
          of your account.
        </P>
        <P>
          Deklata reserves the right to refuse, suspend or terminate any account
          where eligibility requirements are not met or where false information
          has been provided. False representation may result in permanent
          account termination and may attract legal consequences under the{" "}
          <strong>Criminal Offences Act, 1960 (Act 29)</strong> of Ghana and
      ...
      <Section number="3" title="Nature of Service & Platform Role">
        <P>
          Deklata provides a platform for students to connect. The following
          principles define and limit the nature of that service:
        </P>
        <BulletList
          items={[
      ...
      <Section number="5" title="Prohibited Items & Activities">
        <P>
          The following items are strictly prohibited from being listed on
          Deklata under any circumstances:
        </P>
        <BulletList
          items={[
            "Firearms, ammunition, weapons, explosives, or any item regulated under the Arms and Ammunition Act, 1972 (NRCD 9) of Ghana.",
            ...
            "Sex toys, adult sexual devices, or products primarily intended for sexual stimulation or intimate use.",
            "University properties/materials including books that are prohinited from being shared.",
            "Any item whose listing, possession or transfer is prohibited under Ghanaian law or applicable international law.",
          ]}
        />
        <P>
          The following <strong>activities</strong> are strictly prohibited on
          Deklata:
        </P>
        <BulletList
          items={[
            ...
            "Using the platform to solicit, offer, request, promote or facilitate sexual services, romantic or intimate encounters, dating arrangements, companionship services, or any activity of sexual or exploitative nature.",
          ]}
        />
        <P>
          Deklata reserves the right to immediately remove any listing and
          suspend or permanently terminate any account found in violation of
          these prohibitions, without notice and without liability to the user.
        </P>
      </Section>
      ...
      <Section number="6" title="Item Listings & Content Standards">
        ...
        />
        <P>
          You grant Deklata a non-exclusive, royalty-free, worldwide licence to
          display, reproduce and use any content you upload to the platform
          solely for the purpose of operating and improving the service. You
          retain ownership of your content but acknowledge that Deklata may
          remove any content at its discretion without notice.
        </P>
        <P>
          Deklata does not pre-screen listings but reserves the right to remove
          any listing that violates these Terms or that Deklata, in its sole
          discretion, considers inappropriate, misleading, unsafe or harmful.
        </P>
      </Section>

      <Section number="7" title="Contact Information & Privacy">
        <P>
          Contact details — specifically your name and phone number — are
          treated as follows:
        </P>
        <BulletList
          items={[
      ...
      <Section number="8" title="Exchanges, Pickups & Physical Safety">
        <P>
          All physical exchanges between users occur entirely outside of
          Deklata's control, oversight or involvement. Deklata has no presence
          at, knowledge of, or responsibility for any physical meeting between
          users.
        </P>
        ...
        />
        <P>
          Deklata strongly encourages all users to report promptly any suspected
          fraud, impersonation, unauthorised use of photographs or identity,
          misleading listings, or abusive conduct through the Contact & Support
          page or by any available communication channel.
        </P>
      </Section>

      <Section number="9" title="Assumption of Risk">
        <P>
          You expressly, knowingly and voluntarily acknowledge and agree that:
        </P>
        <BulletList
          items={[
      ...
      <Section number="10" title="Limitation of Liability">
        <P>
          ...
          <strong>
            Deklata, its founders, directors, officers, employees, contractors,
            agents and affiliates shall not be liable
          </strong>{" "}
          for any of the following, whether arising in contract, tort,
        ...
        />
        <P>
          Where Ghanaian law does not permit the complete exclusion of
          liability, Deklata's total aggregate liability to you for all claims
          arising from or related to your use of the platform shall not exceed
          the sum of <strong>One hundred Ghana Cedis (GHS 100.00)</strong>,
          reflecting the fact that Deklata provides its service entirely free of
          charge.
        </P>
      </Section>
      ...
      <Section number="11" title="Indemnification">
        <P>
          You agree to{" "}
          <strong>fully indemnify, defend and hold harmless</strong> Deklata and
          its founders, directors, officers, employees, contractors and
          affiliates from and against any and all claims, demands, actions,
        ...
        <P>
          ...
          expiration of these Terms and your cessation of use of the platform.
        </P>
      </Section>

      <Section number="12" title="Intellectual Property">
        <P>
          All platform content, design, branding, logos, trademarks, trade
          names, software code, user interface elements, graphics, text and
          proprietary features of Deklata are the{" "}
          <strong>exclusive intellectual property of Deklata</strong> and are
          protected under the <strong>Copyright Act, 2005 (Act 690)</strong> of
          Ghana and applicable international intellectual property laws.
        </P>
        ...
        />
        <P>
          Any unauthorised use of Deklata's intellectual property constitutes
          infringement and may give rise to civil and criminal liability under
          Ghanaian law.
        </P>
        <P>
          You retain ownership of content you upload to Deklata, subject to the
          limited licence granted in Section 6 of these Terms.
        </P>
      </Section>

      <Section number="13" title="Data Protection & Privacy">
        <P>
          Deklata collects and processes personal data in accordance with the{" "}
          <strong>Data Protection Act, 2012 (Act 843) of Ghana</strong> and,
          where applicable, comparable data protection legislation in other
        ...
        />
        <P>
          Deklata implements reasonable and appropriate technical and
          organisational security measures to protect your personal data against
          unauthorised access, disclosure, alteration or destruction. However,{" "}
          <strong>no digital system can guarantee absolute security</strong>.
          You use the platform and provide your data at your own risk in this
          regard.
        </P>
        <P>
          Deklata will not sell, rent or trade your personal data to third
          parties for commercial purposes. Data may be disclosed where required
          by law, court order, or lawful request by a government authority in
          Ghana or another applicable jurisdiction.
        </P>
        <P>
          You have the right under the Data Protection Act to access, correct
          and request deletion of your personal data held by Deklata. Requests
          may be submitted through the Contact & Support page.
        </P>
      </Section>

      <Section number="14" title="Cybersecurity & Platform Availability">
        <P>
          Deklata does not guarantee continuous, uninterrupted or error-free
          access to the platform. The platform may be temporarily unavailable or
          degraded due to:
        </P>
        <BulletList
          items={[
        ...
        />
        <P>
          Such activities may constitute offences under the{" "}
          <strong>Electronic Transactions Act 2008 (Act 772)</strong> and the{" "}
          <strong>Criminal Offences Act 1960 (Act 29)</strong> of Ghana, and
          Deklata reserves the right to report such activities to the
      ...
      <Section number="15" title="Points System & Rewards">
        <P>
          Deklata operates a voluntary points system to recognise and reward
          generous giving behaviour among users. The following terms govern the
          points system:
        </P>
        <BulletList
          items={[
      ...
      <Section number="16" title="Account Suspension & Termination">
        <P>
          Deklata reserves the right, in its sole and absolute discretion, to
          suspend, restrict or permanently terminate your account and access to
          the platform at any time, with or without prior notice, for any reason
        ...
        />
        <P>
          Deklata is under no obligation to provide reasons for account
          suspension or termination. Upon termination, your right to access the
          platform ceases immediately. Any listings you have posted may be
          removed at Deklata's discretion.
        </P>
        <P>
          You may voluntarily close your account at any time by contacting
          Deklata through the Contact & Support page. Termination does not
          affect any obligations or liabilities that arose prior to the date of
          termination, including indemnification obligations under Section 11.
        </P>
      </Section>

      <Section number="17" title="Dispute Resolution & Governing Law">
        <P>
          <strong>User-to-User Disputes:</strong> Deklata strongly encourages
          users to resolve disputes amongst themselves amicably, in good faith
          and without involving Deklata. Deklata is not a party to any dispute
          between users and has no obligation to mediate, arbitrate or otherwise
          intervene.
        </P>
        <P>
          <strong>Disputes with Deklata:</strong> In the event of any dispute,
          claim or controversy arising out of or relating to these Terms or your
          use of the platform, the parties agree to first attempt resolution
          through good faith negotiation. If resolution cannot be reached within
          30 days, either party may pursue the matter through the courts.
        </P>
        <P>
          <strong>Governing Law:</strong> These Terms shall be governed by and
          construed in accordance with the{" "}
          <strong>laws of the Republic of Ghana</strong>, without regard to its
          conflict of law principles.
        </P>
        <P>
          <strong>Jurisdiction:</strong> You irrevocably submit to the exclusive
          jurisdiction of the courts of competent jurisdiction in the Republic
          of Ghana for the resolution of any legal dispute arising from or
          related to these Terms or the use of the platform.
        </P>
        <P>
          <strong>African Regional Context:</strong> Where users are located in
          other African jurisdictions, Deklata acknowledges the applicability of
          regional frameworks including the{" "}
          <strong>
          ...
          where ratified, and will endeavour to act in a manner consistent with
          those frameworks.
        </P>
      </Section>
      ...
      <Section number="18" title="Amendments to These Terms">
        <P>
          Deklata reserves the right to amend, update or replace these Terms at
          any time and at its sole discretion. When changes are made:
        </P>
        <BulletList
          items={[
      ...
      <Section number="19" title="Severability & Entire Agreement">
        <P>
          ...
          necessary to make it enforceable, or severed from these Terms if
          modification is not possible. The validity, legality and
        ...
        <P>
          ...
          Community Guidelines and any other policies published on the platform,
          constitute the entire agreement between you and Deklata with respect
          to your use of the platform and supersede all prior agreements,
          representations, understandings and communications, whether oral or
          written, relating to the same subject matter.
        </P>
        <P>
          <strong>No Waiver:</strong> Deklata's failure to enforce any provision
          of these Terms at any time shall not be construed as a waiver of that
          provision or of the right to enforce it in the future.
        </P>
        <P>
          <strong>No Third-Party Beneficiaries:</strong> These Terms do not
          create any third-party beneficiary rights. No person other than the
          parties to these Terms shall have any right to enforce any provision
          of these Terms.
        </P>
      </Section>
      ...
      <Section number="20" title="Contact & Notices">
        <P>
          ...
          Terms, or if you wish to submit a legal notice to Deklata, please
          contact us through the platform's Contact & Support page.
        </P>
        <P>
          All legal notices to Deklata must be submitted in writing through the
          official contact channels made available on the platform. Notices sent
          through unofficial channels may not be acknowledged.
        </P>
        <P>
          Deklata will respond to legitimate legal notices and data protection
          requests in accordance with applicable Ghanaian law and within the
      ...
      >
        ...
        >
          By using Deklata, you confirm that you have read, understood and
          agreed to these Terms of Use in full. These Terms were last updated on{" "}
          <strong>{EFFECTIVE_DATE}</strong> and are governed by the laws of the
          Republic of Ghana.
        </p>
        <div
          style={{
    ...
    >
      {items.map((item, i) => (
        ...
        >
          ...
          <span
            style={{ fontSize: 14, color: "var(--ink-700)", lineHeight: 1.75 }}
          >
            {item}
          </span>
        </li>
